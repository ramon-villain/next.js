...
var z=Object.assign,A=Object.prototype.hasOwnProperty,ya=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),za={},Fa={};
function Ga(a){if(A.call(Fa,a))return!0;if(A.call(za,a))return!1;if(ya.test(a))return Fa[a]=!0;za[a]=!0;return!1}
...
var Ka=/([A-Z])/g,La=/^ms-/,Ma=Array.isArray,Na=fa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Ta={pending:!1,data:null,method:null,action:null},Ua=ha.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Dispatcher,bb={prefetchDNS:Va,preconnect:Wa,preload:Xa,preloadModule:Ya,preinitStyle:Za,preinitScript:$a,preinitModuleScript:ab},qb=[],rb=y('"></template>'),sb=y("<script>"),tb=y("\x3c/script>"),ub=y('<script src="'),vb=y('<script type="module" src="'),wb=y('" nonce="'),xb=y('" integrity="'),
...
case "input":a.push(S("input"));var R=null,la=null,I=null,ma=null,Aa=null,qa=null,ra=null,sa=null,Oa=null,da;for(da in c)if(A.call(c,da)){var Z=c[da];if(null!=Z)switch(da){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");case "name":R=Z;break;case "formAction":la=Z;break;case "formEncType":I=Z;break;case "formMethod":ma=Z;break;case "formTarget":Aa=Z;break;case "defaultChecked":Oa=Z;break;
case "defaultValue":ra=Z;break;case "checked":sa=Z;break;case "value":qa=Z;break;default:P(a,da,Z)}}var sd=ec(a,d,e,la,I,ma,Aa,R);null!==sa?Zb(a,"checked",sa):null!==Oa&&Zb(a,"checked",Oa);null!==qa?P(a,"value",qa):null!==ra&&P(a,"value",ra);a.push(dc);null!==sd&&sd.forEach(cc,a);return null;case "button":a.push(S("button"));var cb=null,td=null,ud=null,vd=null,wd=null,xd=null,yd=null,db;for(db in c)if(A.call(c,db)){var na=c[db];if(null!=na)switch(db){case "children":cb=na;break;case "dangerouslySetInnerHTML":td=
...
var Gb=Fb.hasOwnProperty(Eb)?Fb[Eb]:void 0;if(null!==Gb){Fb[Eb]=null;var tc=c;if(Gb){2===Gb.length&&(tc=z({},c),nc(tc,Gb));var Hd=Gd.get(Eb);Hd&&(Hd.length=0)}var Id=[];e.scripts.add(Id);Nb(Id,tc)}g&&a.push(Rb);Fd=null}return Fd;case "style":var Hb=c.precedence,Ba=c.href;if(3===f.insertionMode||f.tagScope&1||null!=c.itemProp||"string"!==typeof Hb||"string"!==typeof Ba||""===Ba){a.push(S("style"));var Qa=null,Jd=null,jb;for(jb in c)if(A.call(c,jb)){var Ib=c[jb];if(null!=Ib)switch(jb){case "children":Qa=
Ib;break;case "dangerouslySetInnerHTML":Jd=Ib;break;default:P(a,jb,Ib)}}a.push(Q);var kb=Array.isArray(Qa)?2>Qa.length?Qa[0]:null:Qa;"function"!==typeof kb&&"symbol"!==typeof kb&&null!==kb&&void 0!==kb&&a.push(B(""+kb));gc(a,Jd,Qa);a.push(xc,"style",yc);var Kd=null}else{var Ca=e.styles.get(Hb);if(null!==(d.styleResources.hasOwnProperty(Ba)?d.styleResources[Ba]:void 0)){d.styleResources[Ba]=null;Ca?Ca.hrefs.push(B(Ba)):(Ca={precedence:B(Hb),rules:[],hrefs:[B(Ba)],sheets:new Map},e.styles.set(Hb,Ca));
var Ld=Ca.rules,Ra=null,Md=null,Jb;for(Jb in c)if(A.call(c,Jb)){var uc=c[Jb];if(null!=uc)switch(Jb){case "children":Ra=uc;break;case "dangerouslySetInnerHTML":Md=uc}}var lb=Array.isArray(Ra)?2>Ra.length?Ra[0]:null:Ra;"function"!==typeof lb&&"symbol"!==typeof lb&&null!==lb&&void 0!==lb&&Ld.push(B(""+lb));gc(Ld,Md,Ra)}Ca&&e.boundaryResources&&e.boundaryResources.styles.add(Ca);g&&a.push(Rb);Kd=void 0}return Kd;case "meta":if(3===f.insertionMode||f.tagScope&1||null!=c.itemProp)var Nd=oc(a,c,"meta");
...
var wc=null,Rd=null,Sa;for(Sa in c)if(A.call(c,Sa)){var aa=c[Sa];if(null!=aa){var Sd=Sa;switch(Sa){case "children":wc=aa;break;case "dangerouslySetInnerHTML":Rd=aa;break;case "style":Xb(a,aa);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;case "className":Sd="class";default:if(Ga(Sa)&&"function"!==typeof aa&&"symbol"!==typeof aa&&!1!==aa){if(!0===aa)aa="";else if("object"===typeof aa)continue;a.push(L,Sd,M,B(aa),K)}}}}a.push(Q);gc(a,Rd,wc);return wc}}return zc(a,
c,b)}var xc=y("</"),yc=y(">");function Fc(a,b){b=b.bootstrapChunks;for(var c=0;c<b.length-1;c++)u(a,b[c]);return c<b.length?(c=b[c],b.length=0,x(a,c)):!0}var Gc=y('<template id="'),Hc=y('"></template>'),Ic=y("\x3c!--$--\x3e"),Jc=y('\x3c!--$?--\x3e<template id="'),Kc=y('"></template>'),Lc=y("\x3c!--$!--\x3e"),Mc=y("\x3c!--/$--\x3e"),Nc=y("<template"),Oc=y('"'),Pc=y(' data-dgst="');y(' data-msg="');y(' data-stck="');var Qc=y("></template>");
...
default:a:{e=a;var l=g.toLowerCase();switch(typeof h){case "function":case "symbol":break a}switch(g){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":l="class";h=""+h;break;case "hidden":if(!1===h)break a;h="";break;case "src":case "href":h=""+h;break;default:if(2<g.length&&("o"===g[0]||"O"===g[0])&&("n"===g[1]||"N"===g[1])||!Ga(g))break a;h=""+h}u(e,Qe);u(e,te(l));u(e,Qe);u(e,te(h))}}}u(a,
...
a;var l=g.toLowerCase();switch(typeof h){case "function":case "symbol":break a}switch(g){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":l="class";h=""+h;break;case "hidden":if(!1===h)break a;h="";break;case "src":case "href":h=""+h;break;default:if(2<g.length&&("o"===g[0]||"O"===g[0])&&("n"===g[1]||"N"===g[1])||!Ga(g))break a;h=""+h}u(e,Qe);u(e,B(JSON.stringify(l)));u(e,Qe);u(e,B(JSON.stringify(h)))}}}u(a,
...
g,onShellReady:void 0===h?V:h,onShellError:void 0===l?V:l,onFatalError:void 0===n?V:n,formState:void 0===r?null:r};c=Gg(b,0,null,d,!1,!1);c.parentFlushed=!0;a=Hg(b,null,a,-1,null,c,F,null,d,xf,null,If);q.push(a);return b}function Ig(a,b,c,d,e,f,g,h,l,n,p){a=Fg(a,b,c,d,e,f,g,h,l,n,p);a.trackedPostpones={workingMap:new Map,rootNodes:[],rootSlots:null};return a}var Jg=null;function Ue(){if(Jg)return Jg;var a=Ye.getStore();return a?a:null}
...
b.blockedSegment,null===d)d=f.children,h=b.formatContext,g=b.keyPath,b.formatContext=Qb(h,e,f),b.keyPath=c,Sg(a,b,d,-1),b.formatContext=h,b.keyPath=g;else{g=Ec(d.chunks,e,f,a.resumableState,a.renderState,b.formatContext,d.lastPushedText);d.lastPushedText=!1;h=b.formatContext;l=b.keyPath;b.formatContext=Qb(h,e,f);b.keyPath=c;Sg(a,b,g,-1);b.formatContext=h;b.keyPath=l;a:{b=d.chunks;a=a.resumableState;switch(e){case "title":case "style":case "script":case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "input":case "keygen":case "link":case "meta":case "param":case "source":case "track":case "wbr":break a;
...
case hf:a:if(null!==b.replay){e=b.keyPath;b.keyPath=c;c=f.children;try{Sg(a,b,c,-1)}finally{b.keyPath=e}}else{n=b.keyPath;e=b.blockedBoundary;var p=b.blockedSegment;d=f.fallback;var r=f.children;f=new Set;g=Mg(a,f);null!==a.trackedPostpones&&(g.trackedContentKeyPath=c);l=Gg(a,p.chunks.length,g,b.formatContext,!1,!1);p.children.push(l);p.lastPushedText=!1;var q=Gg(a,0,null,b.formatContext,!1,!1);q.parentFlushed=!0;b.blockedBoundary=g;b.blockedSegment=q;a.renderState.boundaryResources=g.resources;b.keyPath=
c;try{if(Sg(a,b,r,-1),q.lastPushedText&&q.textEmbedded&&q.chunks.push(Rb),q.status=1,Vg(g,q),0===g.pendingTasks&&0===g.status){g.status=1;break a}}catch(F){q.status=4,g.status=4,"object"===typeof F&&null!==F&&F.$$typeof===uf?(a.onPostpone(F.message),h="POSTPONE"):h=Og(a,F),g.errorDigest=h}finally{a.renderState.boundaryResources=e?e.resources:null,b.blockedBoundary=e,b.blockedSegment=p,b.keyPath=n}h=[c[0],"Suspense Fallback",c[2]];n=a.trackedPostpones;null!==n&&(p=[h[1],h[2],[],null],n.workingMap.set(h,
p),5===g.status?n.workingMap.get(c)[4]=p:g.trackedFallbackNode=p);b=Hg(a,null,d,-1,e,l,f,h,b.formatContext,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof e&&null!==e)switch(e.$$typeof){case gf:e=e.render;Vf={};Wf=b;Xf=a;Yf=c;cg=bg=0;dg=-1;eg=0;fg=d;d=e(f,g);f=lg(e,f,d,g);Rg(a,b,c,f,0!==bg,cg,dg);return;case kf:e=e.type;f=Tg(e,f);Ug(a,b,c,d,e,f,g);return;case df:h=f.children;d=b.keyPath;e=e._context;f=f.value;g=e._currentValue;e._currentValue=f;l=zf;zf=f=
...
function W(a,b,c,d,e){if(null!==b.replay&&"number"===typeof b.replay.slots)Wg(a,b,b.replay.slots,d,e);else{b.node=d;b.childIndex=e;if("object"===typeof d&&null!==d){switch(d.$$typeof){case Ze:var f=d.type,g=d.key,h=d.props,l=d.ref,n=wf(f),p=null==g?-1===e?0:e:g;g=[b.keyPath,n,p];if(null!==b.replay)a:{var r=b.replay;e=r.nodes;for(d=0;d<e.length;d++){var q=e[d];if(p===q[1]){if(4===q.length){if(null!==n&&n!==q[0])throw Error("Expected the resume to render <"+q[0]+"> in this slot but instead it rendered <"+
n+">. The tree doesn't match so React will fallback to client rendering.");n=q[2];q=q[3];p=b.node;b.replay={nodes:n,slots:q,pendingTasks:1};try{Ug(a,b,g,c,f,h,l);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--}catch(v){if("object"===typeof v&&null!==v&&(v===Of||"function"===typeof v.then))throw b.node===p&&(b.replay=r),v;b.replay.pendingTasks--;
Xg(a,b.blockedBoundary,v,n,q)}b.replay=r}else{if(f!==hf)throw Error("Expected the resume to render <Suspense> in this slot but instead it rendered <"+(wf(f)||"Unknown")+">. The tree doesn't match so React will fallback to client rendering.");b:{c=void 0;f=q[5];l=q[2];r=q[3];n=null===q[4]?[]:q[4][2];q=null===q[4]?null:q[4][3];p=b.keyPath;var F=b.replay,H=b.blockedBoundary,X=h.children;h=h.fallback;var t=new Set,C=Mg(a,t);C.parentFlushed=!0;C.rootSegmentID=f;b.blockedBoundary=C;b.replay={nodes:l,slots:r,
...
v),C.errorDigest=c,b.replay.pendingTasks--,a.clientRenderedBoundaries.push(C)}finally{a.renderState.boundaryResources=H?H.resources:null,b.blockedBoundary=H,b.replay=F,b.keyPath=p}h=Ng(a,null,{nodes:n,slots:q,pendingTasks:0},h,-1,H,t,[g[0],"Suspense Fallback",g[2]],b.formatContext,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(h)}}e.splice(d,1);break a}}}else Ug(a,b,g,c,f,h,l);return;case $e:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");
...
function Yg(a,b,c,d){var e=b.keyPath;if(-1!==d&&(b.keyPath=[b.keyPath,"Fragment",d],null!==b.replay)){for(var f=b.replay,g=f.nodes,h=0;h<g.length;h++){var l=g[h];if(l[1]===d){d=l[2];l=l[3];b.replay={nodes:d,slots:l,pendingTasks:1};try{Yg(a,b,c,-1);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--}catch(p){if("object"===typeof p&&
null!==p&&(p===Of||"function"===typeof p.then))throw p;b.replay.pendingTasks--;Xg(a,b.blockedBoundary,p,d,l)}b.replay=f;g.splice(h,1);break}}b.keyPath=e;return}f=b.treeContext;g=c.length;if(null!==b.replay&&(h=b.replay.slots,null!==h&&"object"===typeof h)){for(l=0;l<g;l++){d=c[l];b.treeContext=Jf(f,g,l);var n=h[l];"number"===typeof n?(Wg(a,b,n,d,l),delete h[l]):Sg(a,b,d,l)}b.treeContext=f;b.keyPath=e;return}for(h=0;h<g;h++)l=c[h],b.treeContext=Jf(f,g,h),Sg(a,b,l,h);b.treeContext=f;b.keyPath=e}
...
completedRootSegment:null,abortableTasks:n,pingedTasks:c,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],trackedPostpones:null,onError:void 0===e?Eg:e,onPostpone:void 0===l?V:l,onAllReady:void 0===f?V:f,onShellReady:void 0===g?V:g,onShellError:void 0===h?V:h,onFatalError:V,formState:null};a=Ng(d,null,{nodes:b.replayNodes,slots:b.replaySlots,pendingTasks:0},a,-1,null,n,null,b.rootFormatContext,xf,null,If);c.push(a);return d}
function sh(a){return{write:function(b){return a.push(b)},end:function(){a.push(null)},destroy:function(b){a.destroy(b)}}}
exports.prerenderToNodeStream=function(a,b){return new Promise(function(c,d){var e=Ob(b?b.identifierPrefix:void 0,b?b.unstable_externalRuntimeSrc:void 0),f=Ig(a,e,Mb(e,void 0,b?b.bootstrapScriptContent:void 0,b?b.bootstrapScripts:void 0,b?b.bootstrapModules:void 0,b?b.unstable_externalRuntimeSrc:void 0,b?b.importMap:void 0),Pb(b?b.namespaceURI:void 0),b?b.progressiveChunkSize:void 0,b?b.onError:void 0,function(){var l=new ia.Readable({read:function(){lh(f,n)}}),n=sh(l);l={postponed:nh(f),prelude:l};
c(l)},void 0,void 0,d,b?b.onPostpone:void 0);if(b&&b.signal){var g=b.signal;if(g.aborted)mh(f,g.reason);else{var h=function(){mh(f,g.reason);g.removeEventListener("abort",h)};g.addEventListener("abort",h)}}kh(f)})};
